...
var EVENT_TYPES = {
  ...
  AWAY_STATUS_CHANGED: 'AWAY_STATUS_CHANGED',
  AWAY_AUTO_SKIPPED: 'AWAY_AUTO_SKIPPED',
  AWAY_HANDOFF: 'AWAY_HANDOFF',
...
var ERROR_CODES = {
  ...
  INVALID_DELEGATE_ROOM: 'INVALID_DELEGATE_ROOM',
  DUTY_UNASSIGNED: 'DUTY_UNASSIGNED',
  CANNOT_NUDGE_YOURSELF: 'CANNOT_NUDGE_YOURSELF',
};
